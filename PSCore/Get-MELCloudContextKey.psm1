function Get-MelCloudContextKey {
    ...
    PROCESS {
            ...
            $LoginData = Invoke-RestMethod -Method POST -Uri $Uri -Body $Body -Headers $Header -ContentType $ContentType
            $Logon = $LoginData.LoginData
            ...
            foreach ( $item in $Logon ) {
               ...
               try {
                  ...
                  $Properties = @{
                        ...
                        ContextKey = $Settings.ContextKey
                        Name = $Settings.Name
                     ...
                     Write-Output $obj | Format-Table ContextKey, Name, CountryName, LanguageCode
