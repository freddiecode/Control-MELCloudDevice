...
PROCESS {
    ...
    try {
        ...
        $Start = Invoke-RestMethod -Uri $Uri -Headers $Header -ContentType $ContentType -Body $Body -Method POST

        Write-Host "Starting up your selected device.." -ForegroundColor Yellow
        
        $Start | ConvertFrom-Json | Select-Object Power, SetTemperature, SetFanSpeed
